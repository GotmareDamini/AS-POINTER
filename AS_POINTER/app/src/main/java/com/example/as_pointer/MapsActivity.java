...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker( new MarkerOptions().position( place3 ).title( "Gorewada Tiger Reserve" )
                .snippet("Timing: Busy Lane " +
                        "Weather: Winter, Rainy") );
    ...
    private void updateMyLocation() {
       ...
       // checkWithDangerLatLon();
        ...
        // Enable the location layeLOCATION_PERMISSION_REQUEST_CODEr. Request the location permission if needed.
